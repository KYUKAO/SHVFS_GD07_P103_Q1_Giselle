...
-- Explain in your own words, one more "special folder," and its use
	A:Editor folder:if scripts that using unity editor namespace exist when build,build will fail.They are used for Editor API. Put it in an Editor Folder so that it automatically operate.
